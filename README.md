...
- The variables starting with **gen_mstr_data** corresponds to the _Gen_Master_Data.ipynb_ and **data*iss*** corresponds to the _Data_issues.ipynb_ file.
- The _Gen_Master_Data_ script lacks any error handling or logging at the moment, due to time limit for this project but that can definately added in the Production code.
...
- _Obviously_ this could be dealt with in a different way after consulting with the client/ASME.
...
- The file **Final.xlsx** should give an idea of how I approached this problem.
